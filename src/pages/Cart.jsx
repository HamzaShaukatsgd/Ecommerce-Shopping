  ...
  return (
    ...
    <div className="m-4">
      ...
      <div className="flex items-center justify-between mt-4 mobile:flex-col">
        ...
        <div className="flex  text-lg hover:cursor-pointer mobile:mt-3 mobile:mb-3">
          <p className='font-bold'>Items in your Cart: 3</p>
          <p className="ml-5 font-bold">Wishlist Item: 0</p>
        </div>

        <button className="btn mobile:pl-[40px] pr-[40px]   ">Checkout</button>
      </div>
      ...
      <div className="flex mt-7 mobile:flex-col">
            ...
            <div className="product flex self-start pl-5">
              ...
              <div className="description flex flex-col ml-5 h-auto justify-between">
                ...
                <p className="flex items-center justify-start">
                  ...
                  <div className="rounded-full border-2 p-[10px] cursor-pointer ml-1 w-[20px] h[20px] bg-blue-600"></div>
                </p>
                <p>
        ...
        <div className=" p-5 flex-[0.4] w-auto h-[50vh] border-2 border-[#8a4af3] rounded-md shadow-lg flex flex-col items-center ">
